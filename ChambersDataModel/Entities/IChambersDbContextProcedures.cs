...
namespace ChambersDataModel.Entities
{
    public partial interface IChambersDbContextProcedures
    {
        ...
        Task<int> spGetStatsAsync(string TagName, DateTime? FirstExcDate, DateTime? LastExcDate, OutputParameter<int?> ExcPointsCount, OutputParameter<double?> MinValue, OutputParameter<double?> MaxValue, OutputParameter<double?> AvergValue, OutputParameter<double?> StdDevValue, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<spPivotExcursionPointsResult>> spPivotExcursionPointsAsync(int? StageDateId, DateTime? StartDate, DateTime? EndDate, double? LowThreashold, double? HiThreashold, TimeSpan? TimeStep, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<spPropagateDeprecatedDecomissionedResult>> spPropagateDeprecatedDecomissionedAsync(int? dStageDateId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
