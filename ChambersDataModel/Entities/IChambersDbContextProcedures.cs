...
namespace ChambersDataModel.Entities
{
    ...
    {
        Task<int> spDriverExcursionsPointsForDateAsync(DateTime? ForDate, int? StageDateId, string TagName, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
