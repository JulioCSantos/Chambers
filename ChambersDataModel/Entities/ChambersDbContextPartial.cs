        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if (!optionsBuilder.IsConfigured) {
                if (DatabaseName == null) {
                    optionsBuilder.UseSqlServer("Data Source=ASUS-Strange2;Initial Catalog=ELChambers;Integrated Security=True");
                }
                else {
                    optionsBuilder.UseSqlServer($"Data Source=ASUS-Strange2;Initial Catalog={DatabaseName};Integrated Security=True");
                }
